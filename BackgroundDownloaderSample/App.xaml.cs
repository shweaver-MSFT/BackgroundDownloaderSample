...
namespace BackgroundDownloaderSample
{
    ...
    sealed partial class App : Application
    {
        ...
        public static BackgroundDownloadService BackgroundDownloadService => BackgroundDownloadService.Instance;
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.Kind == ActivationKind.Launch)
            {
                ...
                await BackgroundDownloadService.DiscoverActiveDownloadsAsync();
            }
        }
